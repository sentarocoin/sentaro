...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Sentaro
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Sentaro
    // Mac: ~/Library/Application Support/Sentaro
    // Unix: ~/.sentaro
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sentaro";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "sentaro.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "sentarod.pid"));
