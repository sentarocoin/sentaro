    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Sentaro") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/sentaro"));
    setWindowIcon(QIcon(":icons/sentaro"));
#else
    //setUnifiedTitleAndToolBarOnMac(true);
    QApplication::setAttribute(Qt::AA_DontShowIconsInMenus);
#endif
    setObjectName("sentaro");
    setStyleSheet("#sentaro { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Sentaro address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/sentaro"), tr("&Sentaro Net"), this);
    ...
    aboutAction = new QAction(tr("&About Sentaro"), this);
    aboutAction->setToolTip(tr("Show information about Sentaro"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Sentaro"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/sentaro"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/sentaro_testnet"));
            setWindowIcon(QIcon(":icons/sentaro_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/sentaro_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Sentaro client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Sentaro client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sentaro network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Sentaro address or malformed URI parameters."));
    }
